...
export async function saveGame(userId, {
  ...
  visitedZones, visitDays, lunchesBought, tradesCompleted, giftsGiven, giftsReceived,
}) {
  const data = {
    v: 1, zoneId, x, y, foundKeys, studentId, enrolledAt, highScores, orientationDone, elective, dailyTasksDay, dailyFlags, cards,
    visitedZones, visitDays, lunchesBought, tradesCompleted, giftsGiven, giftsReceived, savedAt: Date.now(),
  };
