...
export const RECIPES = [
  ...
  // Phase 8 — building expansion: decorative full-cube variants.
  { id: 'polished_stone', inputs: [{ id: BLOCKS.STONE_BRICK, count: 2 }], output: { id: BLOCKS.POLISHED_STONE, count: 2 } },
  { id: 'carved_plank', inputs: [{ id: BLOCKS.PLANK, count: 2 }, { id: BLOCKS.STICK, count: 1 }], output: { id: BLOCKS.CARVED_PLANK, count: 2 } },
  { id: 'roof_tile', inputs: [{ id: BLOCKS.STONE_BRICK, count: 2 }, { id: BLOCKS.ORE, count: 1 }], output: { id: BLOCKS.ROOF_TILE, count: 4 } },
  { id: 'glass_block', inputs: [{ id: BLOCKS.SAND, count: 2 }, { id: BLOCKS.ORE, count: 1 }], output: { id: BLOCKS.GLASS_BLOCK, count: 2 } },
